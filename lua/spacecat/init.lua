...
local DEFAULT_CONFIG = {
   ...
   colors = require("spacecat.palette"),
   overrides = {},
}
...
local function apply_term_colors(colors)
   ...
   g.terminal_color_3 = colors.matcha
   ...
   g.terminal_color_9 = colors.bright_pink
   g.terminal_color_10 = colors.bright_teal
   g.terminal_color_11 = colors.bright_matcha
   g.terminal_color_12 = colors.bright_blue
   g.terminal_color_13 = colors.bright_purple
